...
public class LogManager {
	...
	static {
		initCompatibility();
		debugable = (getApplicationInfo(MentorzApplication.Companion.getInstance()).flags & ApplicationInfo.FLAG_DEBUGGABLE) != 0;
		log = debugable;
	}
	...
	static {
		instance = new LogManager(MentorzApplication.Companion.getInstance());
	}
	...
	private LogManager(MentorzApplication application) {
	}
