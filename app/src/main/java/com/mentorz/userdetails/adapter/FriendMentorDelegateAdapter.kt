...
class FriendMentorDelegateAdapter(context: Context, adapter: FriendMentorListAdapter, val viewActions: onViewSelectedListener) : ViewTypeDelegateAdapter {
    ...
    inner class NewsViewHolder(parent: ViewGroup) : RecyclerView.ViewHolder(
            parent.inflate(R.layout.mentor_list_item)) {
