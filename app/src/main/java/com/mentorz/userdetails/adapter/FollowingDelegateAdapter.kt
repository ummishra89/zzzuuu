...
import kotlinx.android.synthetic.main.following_list_item.view.*

class FollowingDelegateAdapter(context: Context, adapter: FollowingListAdapter, val viewActions: onViewSelectedListener) : ViewTypeDelegateAdapter {
    ...
    inner class NewsViewHolder(parent: ViewGroup) : RecyclerView.ViewHolder(
            parent.inflate(R.layout.following_list_item)) {
