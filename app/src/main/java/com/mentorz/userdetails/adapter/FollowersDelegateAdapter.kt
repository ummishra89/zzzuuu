...
import kotlinx.android.synthetic.main.followers_list_item.view.*

class FollowersDelegateAdapter(context: Context, adapter: FollowersListAdapter, val viewActions: onViewSelectedListener) : ViewTypeDelegateAdapter {
    ...
    inner class NewsViewHolder(parent: ViewGroup) : RecyclerView.ViewHolder(
            parent.inflate(R.layout.followers_list_item)) {
