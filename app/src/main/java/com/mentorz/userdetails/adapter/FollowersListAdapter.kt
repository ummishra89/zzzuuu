...
class FollowersListAdapter(context: Context, listener: FollowersDelegateAdapter.onViewSelectedListener) : BaseAdapter<FollowingListAdapter, RecyclerView.ViewHolder>() {
    ...
    init {
        ...
        delegateAdapters.put(AdapterConstants.ITEMS, FollowersDelegateAdapter(context,this, listener))
        items = mutableListOf()
