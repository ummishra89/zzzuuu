...
class FollowingListAdapter(context: Context,listener: FollowingDelegateAdapter.onViewSelectedListener) : BaseAdapter<FollowingListAdapter, RecyclerView.ViewHolder>() {
    ...
    init {
        ...
        delegateAdapters.put(AdapterConstants.ITEMS, FollowingDelegateAdapter(context,this, listener))
        items = mutableListOf()
