...
class FriendMentorListAdapter(context: Context, listener: FriendMentorDelegateAdapter.onViewSelectedListener) : BaseAdapter<FriendMentorListAdapter,RecyclerView.ViewHolder>() {
    ...
    init {
        ...
        delegateAdapters.put(AdapterConstants.ITEMS, FriendMentorDelegateAdapter(context,this, listener))
        items = mutableListOf()
