...
import com.mentorz.userdetails.adapter.FollowingDelegateAdapter
import com.mentorz.userdetails.adapter.FollowingListAdapter
 ...
 */
class FollowingFragment : BaseFragment(), UserDetailsView, FollowingDelegateAdapter.onViewSelectedListener {
    ...
    override fun setFollowingAdapter(userList: MutableList<UserListItem>) {
        activity?.runOnUiThread {
            if (pageNo == 0) {
                swipeToRefresh.isRefreshing = false
    ...
    var adapter: FollowingListAdapter?=null
    var friendId:Long=0
    var pageNo:Int=0
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        adapter = FollowingListAdapter(activity,this)
        ...
        adapter!!.setOnLoadMoreListener(recyclerView,object : OnLoadMoreListener {
            override fun onLoadMore() {
                ...
                presenter.getFollowing(friendId,++pageNo,false)
            }
        })
        presenter.getFollowing(friendId,0,false)
        swipeToRefresh.setOnRefreshListener {
            swipeToRefresh.isRefreshing = true
            pageNo = 0
            presenter.getFollowing(friendId,pageNo,true)
        }
