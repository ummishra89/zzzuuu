...
import com.mentorz.userdetails.adapter.FollowersDelegateAdapter
import com.mentorz.userdetails.adapter.FollowersListAdapter
 ...
 */
class FollowersFragment : BaseFragment(), UserDetailsView, FollowersDelegateAdapter.onViewSelectedListener {
    ...
    override fun setFollowersAdapter(userList: MutableList<UserListItem>) {
        activity?.runOnUiThread {
            if (pageNo == 0) {
                swipeToRefresh.isRefreshing = false
    ...
    var adapter: FollowersListAdapter?=null
    var friendId:Long=0
    var pageNo:Int=0
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        adapter = FollowersListAdapter(activity,this)
        ...
        adapter!!.setOnLoadMoreListener(recyclerView,object : OnLoadMoreListener {
            override fun onLoadMore() {
                    ...
                    presenter.getFollowers(friendId,++pageNo,false)
            }
        })
        presenter.getFollowers(friendId,0,false)
        swipeToRefresh.setOnRefreshListener {
            swipeToRefresh.isRefreshing = true
            pageNo = 0
            presenter.getFollowers(friendId,pageNo,true)
        }
