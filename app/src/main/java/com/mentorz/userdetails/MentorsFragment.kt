...
import com.mentorz.userdetails.adapter.FriendMentorDelegateAdapter
import com.mentorz.userdetails.adapter.FriendMentorListAdapter
import com.mentorz.utils.Constant
import kotlinx.android.synthetic.main.fragment_mentors.*

/**
 * A simple [Fragment] subclass.
 */
class MentorsFragment : BaseFragment(), UserDetailsView, FriendMentorDelegateAdapter.onViewSelectedListener {
    ...
    override fun setMentorsAdapter(userList: MutableList<UserListItem>) {
        activity?.runOnUiThread {
            if (pageNo == 0) {
                swipeToRefresh.isRefreshing = false
    ...
    var adapter: FriendMentorListAdapter?=null
    var friendId:Long=0
    var pageNo:Int=0
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        adapter = FriendMentorListAdapter(activity,this)
        ...
        adapter!!.setOnLoadMoreListener(recyclerView,object : OnLoadMoreListener {
            override fun onLoadMore() {
                ...
                presenter.getMentors(friendId,++pageNo,false)
            }
        })
        presenter.getMentors(friendId,0,false)
        swipeToRefresh.setOnRefreshListener {
            swipeToRefresh.isRefreshing = true
            pageNo = 0
            presenter.getMentors(friendId,pageNo,true)
        }
